...
if (!file.exists("../windows/tesseract/include/tesseract/baseapi.h")) {
  ...
  url <- if (grepl("aarch", R.version$platform)) {
    "https://github.com/pachadotdev/readpdf/releases/download/tesseract-5.3.2/tesseract-ocr-5.3.2-clang-aarch64.tar.xz"
  } else if (grepl("clang", Sys.getenv("R_COMPILED_BY"))) {
    "https://github.com/pachadotdev/readpdf/releases/download/tesseract-5.3.2/tesseract-ocr-5.3.2-clang-x86_64.tar.xz"
  } else if (getRversion() >= "4.3") {
    "https://github.com/pachadotdev/readpdf/releases/download/tesseract-5.3.2/tesseract-ocr-5.3.2-ucrt-x86_64.tar.xz"
  }
...
if (!file.exists("../windows/poppler/include/poppler/cpp/poppler-document.h")) {
  ...
  url <- if (grepl("aarch", R.version$platform)) {
    "https://github.com/pachadotdev/readpdf/releases/download/poppler-23.08.0/poppler-23.08.0-clang-aarch64.tar.xz"
  } else if (grepl("clang", Sys.getenv("R_COMPILED_BY"))) {
    "https://github.com/pachadotdev/readpdf/releases/download/poppler-23.08.0/poppler-23.08.0-clang-x86_64.tar.xz"
  } else if (getRversion() >= "4.3") {
    "https://github.com/pachadotdev/readpdf/releases/download/poppler-23.08.0/poppler-23.08.0-ucrt-x86_64.tar.xz"
  }
  download.file(url, basename(url), quiet = TRUE)
  untar(basename(url), exdir = "../windows/", tar = "internal")
