...
On __Fedora__ you need [tesseract-devel](https://src.fedoraproject.org/rpms/tesseract) and
...
On __RHEL__ and __CentOS__ you need [tesseract-devel](https://src.fedoraproject.org/rpms/tesseract) and
